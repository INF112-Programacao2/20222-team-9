...
public:
    ...
    void setupUi(QDialog *screen_home)
    {
        if (screen_home->objectName().isEmpty())
            screen_home->setObjectName("screen_home");
...
"font: 700 12pt \"Microsoft YaHei UI\";"));
        ...
        lb_image_disc->setObjectName("lb_image_disc");
        ...
        lb_nome_album->setObjectName("lb_nome_album");
        ...
        lb_nome_cantor->setObjectName("lb_nome_cantor");
        ...
        new QListWidgetItem(lw_musicas);
        new QListWidgetItem(lw_musicas);
        lw_musicas->setObjectName("lw_musicas");
...
""));
        ...
        pb_ver_album->setObjectName("pb_ver_album");
...
""));
        ...
        pb_profile_home->setObjectName("pb_profile_home");
