...
public:
    ...
    void setupUi(QDialog *screen_cart)
    {
        if (screen_cart->objectName().isEmpty())
            screen_cart->setObjectName("screen_cart");
...
"color:rgb(255, 255, 255)"));
        ...
        lb_nome_cantor_cart->setObjectName("lb_nome_cantor_cart");
        ...
        lb_ano_lancamento_cart->setObjectName("lb_ano_lancamento_cart");
        ...
        lb_price_cart->setObjectName("lb_price_cart");
...
""));
        ...
        pb_home_cart->setObjectName("pb_home_cart");
...
""));
        ...
        pb_profile_cart->setObjectName("pb_profile_cart");
...
""));
        ...
        lb_preco_total->setObjectName("lb_preco_total");
