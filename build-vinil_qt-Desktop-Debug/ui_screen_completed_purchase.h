...
public:
    ...
    void setupUi(QDialog *screen_completed_purchase)
    {
        if (screen_completed_purchase->objectName().isEmpty())
            screen_completed_purchase->setObjectName(QString::fromUtf8("screen_completed_purchase"));
...
"color:rgb(255, 255, 255)"));
        ...
        icon_Perfil->setObjectName(QString::fromUtf8("icon_Perfil"));
...
""));
        ...
        ion_Cart->setObjectName(QString::fromUtf8("ion_Cart"));
