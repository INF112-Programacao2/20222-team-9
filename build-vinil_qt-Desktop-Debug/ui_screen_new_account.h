...
public:
    ...
    void setupUi(QDialog *screen_new_account)
    {
        if (screen_new_account->objectName().isEmpty())
            screen_new_account->setObjectName(QString::fromUtf8("screen_new_account"));
...
"color:rgb(255, 255, 255)"));
        ...
        QFont font3;
        font3.setFamily(QString::fromUtf8("Microsoft New Tai Lue"));
        ...
        ln_nome->setObjectName(QString::fromUtf8("ln_nome"));
...
"border-style: outset;"));
        ...
        ln_cpf->setObjectName(QString::fromUtf8("ln_cpf"));
